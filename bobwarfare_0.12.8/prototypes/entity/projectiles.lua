...
--          },
...

  {
    ...
    flags = {"not-on-map"},
    acceleration = 0.005,
    action = boblaseraction("bob-laser-bubble-glass", 30),
...

  {
    ...
    flags = {"not-on-map"},
    acceleration = 0.005,
    action = boblaseraction("bob-laser-bubble-ruby", 35),
    light = {intensity = 0.5, size = 10},
...

  {
    ...
    flags = {"not-on-map"},
    acceleration = 0.005,
    action = boblaseraction("bob-laser-bubble-sapphire", 40),
    light = {intensity = 0.5, size = 10},
...

  {
    ...
    flags = {"not-on-map"},
    acceleration = 0.005,
    action = boblaseraction("bob-laser-bubble-emerald", 45),
    light = {intensity = 0.5, size = 10},
...

  {
    ...
    flags = {"not-on-map"},
    acceleration = 0.005,
    action = boblaseraction("bob-laser-bubble-amethyst", 50),
    light = {intensity = 0.5, size = 10},
    animation = boblaseranimation(1, {r=1, g=0.2, b=1, a=1}),
    speed = 0.15
  },

  {
    ...
    flags = {"not-on-map"},
    acceleration = 0.005,
    action = boblaseraction("bob-laser-bubble-topaz", 55),
    light = {intensity = 0.5, size = 10},
...

  {
    ...
    flags = {"not-on-map"},
    acceleration = 0.005,
    action = boblaseraction("bob-laser-bubble-diamond", 60),
    light = {intensity = 0.5, size = 10},
