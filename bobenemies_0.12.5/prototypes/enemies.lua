...
{
  {
    ...
    result_units =
    {
      ...
      {"medium-biter", {{0.3, 0.0}, {0.6, 0.3}, {0.9, 0.0}}},
      {"big-biter", {{0.6, 0.0}, {0.9, 0.4}}},
      {"bob-bigger-biter", {{0.7, 0.0}, {0.9, 0.3}}},
      {"bob-biggest-biter", {{0.9, 0.0}, {1.0, 0.2}}},
      {"bob-fire-biter", {{0.9, 0.0}, {1.0, 0.1}}},
    },
...

  {
    ...
    result_units =
    {
      ...
      {"medium-spitter", {{0.5, 0.0}, {0.6, 0.3}, {0.9, 0.0}}},
      {"big-spitter", {{0.6, 0.0}, {0.9, 0.4}}},
      {"bob-bigger-spitter", {{0.7, 0.0}, {0.9, 0.3}}},
      {"bob-biggest-spitter", {{0.9, 0.0}, {1.0, 0.2}}},
      {"bob-poison-spitter", {{0.9, 0.0}, {1.0, 0.1}}},
    },
    -- With zero evolution the spawn rate is 5 seconds, with max evolution it is 2 seconds
    spawning_cooldown = {300, 120},
    spawning_radius = 10,
